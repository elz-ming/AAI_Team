...
travel_table <- gt(travel_data) %>%
  ...
  tab_source_note(
    source_note = html("Legend: <span style='display:inline-block; width:10px; height:10px; background-color:red; margin-right:5px;'></span>low 1 | <span style='display:inline-block; width:10px; height:10px; background-color:yellow; margin-right:5px;'></span>low 2")
  )
